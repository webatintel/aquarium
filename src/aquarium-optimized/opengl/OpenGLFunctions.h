...
struct OpenGLFunctions
{
  ...
  public:
    ...
    bool LoadDesktopGLProcs(int majorVersion, int minorVersion);
    bool LoadOpenGLESProcs(int majorVersion, int minorVersion);

  private:
    template <typename T>
    bool LoadProc(T *memberProc, const char *name);
