...
IMGUI_IMPL_API void ImGui_ImplDX12_NewFrame(int MSAASampleCount, bool enableAlphaBlending);
...
IMGUI_IMPL_API bool ImGui_ImplDX12_CreateDeviceObjects(int MSAASampleCount, bool enableAlphaBlending);
